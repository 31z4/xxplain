...
def extract_features(
    ...
    if all([pg_stat_row is not None, pg_stat_user_tables is not None and pg_indexes is not None]):
        time, size = _extract_from_pg_stat_statement(features, pg_stat_row)
